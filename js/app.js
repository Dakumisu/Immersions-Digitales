...
import fragmentShaderHorizontal from "../assets/glsl/fragmentHorizontal.glsl";
...
let texture1Default = textureLoader.load(atelier1Default)
let texture1Hover = textureLoader.load(atelier1Hover)

let texture2Default = textureLoader.load(atelier2Default)
let texture2Hover = textureLoader.load(atelier2Hover)

let texture3Default = textureLoader.load(atelier3Default)
let texture3Hover = textureLoader.load(atelier3Hover)

let texture4Default = textureLoader.load(atelier4Default)
let texture4Hover = textureLoader.load(atelier4Hover)

let texture5Default = textureLoader.load(atelier5Default)
let texture5Hover = textureLoader.load(atelier5Hover)

let texture6Default = textureLoader.load(atelier6Default)
let texture6Hover = textureLoader.load(atelier6Hover)

let texture7Default = textureLoader.load(atelier7Default)
let texture7Hover = textureLoader.load(atelier7Hover)

let texture8Default = textureLoader.load(atelier8Default)
let texture8Hover = textureLoader.load(atelier8Hover)

let texture9Default = textureLoader.load(atelier9Default)
let texture9Hover = textureLoader.load(atelier9Hover)

let texture10Default = textureLoader.load(atelier10Default)
let texture10Hover = textureLoader.load(atelier10Hover)

let texture11Default = textureLoader.load(atelier11Default)
let texture11Hover = textureLoader.load(atelier11Hover)

let texture12Default = textureLoader.load(atelier12Default)
let texture12Hover = textureLoader.load(atelier12Hover)

let texture13Default = textureLoader.load(atelier13Default)
let texture13Hover = textureLoader.load(atelier13Hover)

let texture14Default = textureLoader.load(atelier14Default)
let texture14Hover = textureLoader.load(atelier14Hover)

var texturebaniere14 = textureLoader.load(atelierbaniere1);
var texturebaniere13 = textureLoader.load(atelierbaniere2);
var texturebaniere12 = textureLoader.load(atelierbaniere3);
var texturebaniere11 = textureLoader.load(atelierbaniere4);
var texturebaniere10 = textureLoader.load(atelierbaniere5);
var texturebaniere9 = textureLoader.load(atelierbaniere6);
var texturebaniere8 = textureLoader.load(atelierbaniere7);
var texturebaniere7 = textureLoader.load(atelierbaniere8);
var texturebaniere6 = textureLoader.load(atelierbaniere9);
var texturebaniere5 = textureLoader.load(atelierbaniere10);
var texturebaniere4 = textureLoader.load(atelierbaniere11);
var texturebaniere3 = textureLoader.load(atelierbaniere12);
var texturebaniere2 = textureLoader.load(atelierbaniere13);
var texturebaniere1 = textureLoader.load(atelierbaniere14);

var texturechiffre1 = textureLoader.load(atelierchiffre1);
var texturechiffre2 = textureLoader.load(atelierchiffre2);
var texturechiffre3 = textureLoader.load(atelierchiffre3);
var texturechiffre4 = textureLoader.load(atelierchiffre4);
var texturechiffre5 = textureLoader.load(atelierchiffre5);
var texturechiffre6 = textureLoader.load(atelierchiffre6);
var texturechiffre7 = textureLoader.load(atelierchiffre7);
var texturechiffre8 = textureLoader.load(atelierchiffre8);
var texturechiffre9 = textureLoader.load(atelierchiffre9);
var texturechiffre10 = textureLoader.load(atelierchiffre10);
var texturechiffre11 = textureLoader.load(atelierchiffre11);
var texturechiffre12 = textureLoader.load(atelierchiffre12);
var texturechiffre13 = textureLoader.load(atelierchiffre13);
var texturechiffre14 = textureLoader.load(atelierchiffre14);

var texturepanneaurue1 = textureLoader.load(atelierpanneaurue1);
var texturepanneaurue2 = textureLoader.load(atelierpanneaurue2);
var texturepanneaurue3 = textureLoader.load(atelierpanneaurue3);
var texturepanneaurue4 = textureLoader.load(atelierpanneaurue4);
var texturepanneaurue5 = textureLoader.load(atelierpanneaurue5);
var texturepanneaurue6 = textureLoader.load(atelierpanneaurue6);
var texturepanneaurue7 = textureLoader.load(atelierpanneaurue7);
var texturepanneaurue8 = textureLoader.load(atelierpanneaurue8);
var texturepanneaurue9 = textureLoader.load(atelierpanneaurue9);
var texturepanneaurue10 = textureLoader.load(atelierpanneaurue10);
var texturepanneaurue11 = textureLoader.load(atelierpanneaurue11);
var texturepanneaurue12 = textureLoader.load(atelierpanneaurue12);
var texturepanneaurue13 = textureLoader.load(atelierpanneaurue13);
var texturepanneaurue14 = textureLoader.load(atelierpanneaurue14);

var texturepanneau1 = textureLoader.load(atelierpanneau1);
var texturepanneau2 = textureLoader.load(atelierpanneau2);
var texturepanneau3 = textureLoader.load(atelierpanneau3);
var texturepanneau4 = textureLoader.load(atelierpanneau4);
var texturepanneau5 = textureLoader.load(atelierpanneau5);
var texturepanneau6 = textureLoader.load(atelierpanneau6);
var texturepanneau7 = textureLoader.load(atelierpanneau7);
var texturepanneau8 = textureLoader.load(atelierpanneau8);
var texturepanneau9 = textureLoader.load(atelierpanneau9);
var texturepanneau10 = textureLoader.load(atelierpanneau10);
var texturepanneau11 = textureLoader.load(atelierpanneau11);
var texturepanneau12 = textureLoader.load(atelierpanneau12);
var texturepanneau13 = textureLoader.load(atelierpanneau13);
var texturepanneau14 = textureLoader.load(atelierpanneau14);

var texturepanneau2rue1 = textureLoader.load(atelierpanneau2rue1);
var texturepanneau2rue2 = textureLoader.load(atelierpanneau2rue2);
var texturepanneau2rue3 = textureLoader.load(atelierpanneau2rue3);
var texturepanneau2rue4 = textureLoader.load(atelierpanneau2rue4);
var texturepanneau2rue5 = textureLoader.load(atelierpanneau2rue5);
var texturepanneau2rue6 = textureLoader.load(atelierpanneau2rue6);
var texturepanneau2rue7 = textureLoader.load(atelierpanneau2rue7);
var texturepanneau2rue8 = textureLoader.load(atelierpanneau2rue8);
var texturepanneau2rue9 = textureLoader.load(atelierpanneau2rue9);
var texturepanneau2rue10 = textureLoader.load(atelierpanneau2rue10);
var texturepanneau2rue11 = textureLoader.load(atelierpanneau2rue11);
var texturepanneau2rue12 = textureLoader.load(atelierpanneau2rue12);
var texturepanneau2rue13 = textureLoader.load(atelierpanneau2rue13);
var texturepanneau2rue14 = textureLoader.load(atelierpanneau2rue14);

var textureidbaniere = textureLoader.load(idbaniere);
var texturecredits = textureLoader.load(credits);
...
var materialPlane1 = new THREE.ShaderMaterial({
    ...
    uniforms: {
        ...
        displacement: { type: "t", value: textureLoader.load(displacement4) },
        dispFactor: { type: "f", value: 0.0 },
        effectFactor: { type: "f", value: 1 },
    },
...
var materialPlanePanneau = new THREE.ShaderMaterial({
    ...
    uniforms: {
        ...
        displacement: { type: "t", value: textureLoader.load(displacement2) },
...
queue.loadFile(fragmentShaderHorizontal);
...
if (!window.matchMedia("(max-width: 1024px)").matches) {
    ...
    queue.loadFile(atelierpanneau5);
    queue.loadFile(atelierpanneau6);
    queue.loadFile(atelierpanneau7);
    queue.loadFile(atelierpanneau8);
    queue.loadFile(atelierpanneau9);
    queue.loadFile(atelierpanneau10);
    queue.loadFile(atelierpanneau11);
    queue.loadFile(atelierpanneau12);
    queue.loadFile(atelierpanneau13);
    queue.loadFile(atelierpanneau14);

    queue.loadFile(atelierpanneaurue1);
    queue.loadFile(atelierpanneaurue2);
    queue.loadFile(atelierpanneaurue3);
    queue.loadFile(atelierpanneaurue4);
    queue.loadFile(atelierpanneaurue5);
    queue.loadFile(atelierpanneaurue6);
    queue.loadFile(atelierpanneaurue7);
    queue.loadFile(atelierpanneaurue8);
    queue.loadFile(atelierpanneaurue9);
    queue.loadFile(atelierpanneaurue10);
    queue.loadFile(atelierpanneaurue11);
    queue.loadFile(atelierpanneaurue12);
    queue.loadFile(atelierpanneaurue13);
    queue.loadFile(atelierpanneaurue14);

    queue.loadFile(atelierpanneau2rue1);
    queue.loadFile(atelierpanneau2rue2);
    queue.loadFile(atelierpanneau2rue3);
    queue.loadFile(atelierpanneau2rue4);
    queue.loadFile(atelierpanneau2rue5);
    queue.loadFile(atelierpanneau2rue6);
    queue.loadFile(atelierpanneau2rue7);
    queue.loadFile(atelierpanneau2rue8);
    queue.loadFile(atelierpanneau2rue9);
    queue.loadFile(atelierpanneau2rue10);
    queue.loadFile(atelierpanneau2rue11);
    queue.loadFile(atelierpanneau2rue12);
    queue.loadFile(atelierpanneau2rue13);
    queue.loadFile(atelierpanneau2rue14);

    queue.loadFile(atelierbaniere1);
    queue.loadFile(atelierbaniere2);
    queue.loadFile(atelierbaniere3);
    queue.loadFile(atelierbaniere4);
    queue.loadFile(atelierbaniere5);
    queue.loadFile(atelierbaniere6);
    queue.loadFile(atelierbaniere7);
    queue.loadFile(atelierbaniere8);
    queue.loadFile(atelierbaniere9);
    queue.loadFile(atelierbaniere10);
    queue.loadFile(atelierbaniere11);
    queue.loadFile(atelierbaniere12);
    queue.loadFile(atelierbaniere13);
    queue.loadFile(atelierbaniere14);

    queue.loadFile(atelierchiffre1);
    queue.loadFile(atelierchiffre2);
    queue.loadFile(atelierchiffre3);
    queue.loadFile(atelierchiffre4);
    queue.loadFile(atelierchiffre5);
    queue.loadFile(atelierchiffre6);
    queue.loadFile(atelierchiffre7);
    queue.loadFile(atelierchiffre8);
    queue.loadFile(atelierchiffre9);
    queue.loadFile(atelierchiffre10);
    queue.loadFile(atelierchiffre11);
    queue.loadFile(atelierchiffre12);
