...
var POSTPROCESSING = (() => {
  ...
  var shader_default13 = "uniform vec2 texelSize;varying vec2 vUv0;varying vec2 vUv1;varying vec2 vUv2;varying vec2 vUv3;void main(){vec2 uv=position.xy*0.5+0.5;vUv0=uv;vUv1=vec2(uv.x,uv.y+texelSize.y);vUv2=vec2(uv.x+texelSize.x,uv.y);vUv3=uv+texelSize;gl_Position=vec4(position.xy,1.0,1.0);}";
  ...
  var DepthPass = class extends Pass {
    constructor(scene, camera, {
      ...
      super("DepthPass");
      this.needsSwap = false;
      this.renderPass = new RenderPass(scene, camera, new import_three24.MeshDepthMaterial({
        depthPacking: import_three24.RGBADepthPacking
      }));
      const clearPass = this.renderPass.getClearPass();
      clearPass.overrideClearColor = new import_three24.Color(16777215);
  ...
  var BlendMode = class extends import_three26.EventDispatcher {
    constructor(blendFunction, opacity = 1) {
      super();
      this.blendFunction = blendFunction;
      this.opacity = new import_three26.Uniform(opacity);
    }
    getBlendFunction() {
  ...
  var Effect = class extends import_three27.EventDispatcher {
    ...
    dispose() {
      for (const key of Object.keys(this)) {
        const property = this[key];
        if (property !== null && typeof property.dispose === "function") {
          if (property instanceof import_three27.Scene) {
            continue;
          }
          this[key].dispose();
        }
  ...
  var NormalPass = class extends Pass {
    constructor(scene, camera, {
      ...
      super("NormalPass");
      this.needsSwap = false;
      this.renderPass = new RenderPass(scene, camera, new import_three28.MeshNormalMaterial());
      const clearPass = this.renderPass.getClearPass();
      clearPass.overrideClearColor = new import_three28.Color(7829503);
      clearPass.overrideClearAlpha = 1;
      this.renderTarget = renderTarget;
      if (this.renderTarget === void 0) {
        this.renderTarget = new import_three28.WebGLRenderTarget(1, 1, {
          ...
          format: import_three28.RGBFormat,
          stencilBuffer: false
        });
  ...
  var EffectComposer = class {
    ...
    get multisampling() {
      return this.inputBuffer instanceof import_three29.WebGLMultisampleRenderTarget ? this.inputBuffer.samples : 0;
    }
    ...
    enableExtensions() {
      ...
      if (frameBufferType !== import_three29.UnsignedByteType) {
        if (capabilities.isWebGL2) {
          context.getExtension("EXT_color_buffer_float");
        } else {
          context.getExtension("EXT_color_buffer_half_float");
    ...
    replaceRenderer(renderer, updateDOM = true) {
      ...
      if (oldRenderer !== null && oldRenderer !== renderer) {
        const oldSize = oldRenderer.getSize(new import_three29.Vector2());
        const newSize = renderer.getSize(new import_three29.Vector2());
    ...
    createDepthTexture() {
      const depthTexture = this.depthTexture = new import_three29.DepthTexture();
      this.inputBuffer.depthTexture = depthTexture;
      this.inputBuffer.dispose();
      if (this.inputBuffer.stencilBuffer) {
        depthTexture.format = import_three29.DepthStencilFormat;
        depthTexture.type = import_three29.UnsignedInt248Type;
      } else {
        depthTexture.type = import_three29.UnsignedIntType;
      }
      return depthTexture;
    }
    deleteDepthTexture() {
    ...
    createBuffer(depthBuffer, stencilBuffer, type, multisampling) {
      const size = this.renderer.getDrawingBufferSize(new import_three29.Vector2());
      const alpha = this.renderer.getContext().getContextAttributes().alpha;
      const options = {
        format: !alpha && type === import_three29.UnsignedByteType ? import_three29.RGBFormat : import_three29.RGBAFormat,
      ...
      const renderTarget = multisampling > 0 ? new import_three29.WebGLMultisampleRenderTarget(size.width, size.height, options) : new import_three29.WebGLRenderTarget(size.width, size.height, options);
      if (multisampling > 0) {
    ...
    addPass(pass, index) {
      ...
      const frameBufferType = this.inputBuffer.texture.type;
      const drawingBufferSize = renderer.getDrawingBufferSize(new import_three29.Vector2());
    ...
    setSize(width, height, updateStyle) {
      ...
      if (width === void 0 || height === void 0) {
        const size = renderer.getSize(new import_three29.Vector2());
        width = size.width;
        height = size.height;
      } else {
  ...
  var shader_default44 = "uniform sampler2D texture;uniform float intensity;void mainImage(const in vec4 inputColor,const in vec2 uv,out vec4 outputColor){outputColor=clamp(texture2D(texture,uv)*intensity,0.0,1.0);}";
  ...
  var BloomEffect = class extends Effect {
    constructor({
      ...
      super("BloomEffect", shader_default44, {
        blendFunction,
        uniforms: new Map([
          ["texture", new import_three30.Uniform(null)],
          ["intensity", new import_three30.Uniform(intensity)]
        ])
      });
      this.renderTarget = new import_three30.WebGLRenderTarget(1, 1, {
        minFilter: import_three30.LinearFilter,
        magFilter: import_three30.LinearFilter,
        stencilBuffer: false,
        depthBuffer: false
      });
    ...
    initialize(renderer, alpha, frameBufferType) {
      ...
      if (!alpha && frameBufferType === import_three30.UnsignedByteType) {
        this.renderTarget.texture.format = import_three30.RGBFormat;
      }
      if (frameBufferType !== void 0) {
        this.renderTarget.texture.type = frameBufferType;
      }
  ...
  var BokehEffect = class extends Effect {
    constructor({blendFunction = BlendFunction.NORMAL, focus = 0.5, dof = 0.02, aperture = 0.015, maxBlur = 1} = {}) {
      super("BokehEffect", shader_default45, {
        ...
        uniforms: new Map([
          ["focus", new import_three31.Uniform(focus)],
          ["dof", new import_three31.Uniform(dof)],
          ["aperture", new import_three31.Uniform(aperture)],
          ["maxBlur", new import_three31.Uniform(maxBlur)]
        ])
      });
    }
  };
  ...
  var BrightnessContrastEffect = class extends Effect {
    constructor({blendFunction = BlendFunction.NORMAL, brightness = 0, contrast = 0} = {}) {
      super("BrightnessContrastEffect", shader_default46, {
        blendFunction,
        uniforms: new Map([
          ["brightness", new import_three32.Uniform(brightness)],
          ["contrast", new import_three32.Uniform(contrast)]
        ])
      });
    }
  };
  ...
  var ColorDepthEffect = class extends Effect {
    constructor({blendFunction = BlendFunction.NORMAL, bits = 16} = {}) {
      super("ColorDepthEffect", shader_default48, {
        blendFunction,
        uniforms: new Map([
          ["factor", new import_three33.Uniform(1)]
        ])
      });
      this.bits = 0;
  ...
  var ChromaticAberrationEffect = class extends Effect {
    constructor({blendFunction = BlendFunction.NORMAL, offset = new import_three34.Vector2(1e-3, 5e-4)} = {}) {
      super("ChromaticAberrationEffect", shader_default49, {
        vertexShader: shader_default50,
        blendFunction,
        attributes: EffectAttribute.CONVOLUTION,
        uniforms: new Map([
          ["offset", new import_three34.Uniform(offset)]
        ])
      });
    }
    get offset() {
  ...
  var DepthOfFieldEffect = class extends Effect {
    constructor(camera, {
      ...
      super("DepthOfFieldEffect", shader_default52, {
        ...
        attributes: EffectAttribute.DEPTH,
        uniforms: new Map([
          ["nearColorBuffer", new import_three35.Uniform(null)],
          ["farColorBuffer", new import_three35.Uniform(null)],
          ["nearCoCBuffer", new import_three35.Uniform(null)],
          ["scale", new import_three35.Uniform(1)]
        ])
      });
      this.camera = camera;
      this.renderTarget = new import_three35.WebGLRenderTarget(1, 1, {
      ...
      this.renderTargetCoC.texture.format = import_three35.RGBFormat;
    ...
    initialize(renderer, alpha, frameBufferType) {
      ...
      this.blurPass.initialize(renderer, alpha, import_three35.UnsignedByteType);
      if (!alpha && frameBufferType === import_three35.UnsignedByteType) {
        this.renderTargetNear.texture.type = import_three35.RGBFormat;
      }
      if (frameBufferType !== void 0) {
        this.renderTarget.texture.type = frameBufferType;
  ...
  var DotScreenEffect = class extends Effect {
    constructor({blendFunction = BlendFunction.NORMAL, angle = Math.PI * 0.5, scale = 1} = {}) {
      super("DotScreenEffect", shader_default53, {
        blendFunction,
        uniforms: new Map([
          ["angle", new import_three36.Uniform(new import_three36.Vector2())],
          ["scale", new import_three36.Uniform(scale)]
        ])
      });
      this.setAngle(angle);
    }
  ...
  var GammaCorrectionEffect = class extends Effect {
    constructor({blendFunction = BlendFunction.NORMAL, gamma = 2} = {}) {
      super("GammaCorrectionEffect", shader_default54, {
        blendFunction,
        uniforms: new Map([
          ["gamma", new import_three37.Uniform(gamma)]
        ])
      });
    }
  };
  ...
  function getNoise(size, format, type) {
    const channels = new Map([
      [import_three38.LuminanceFormat, 1],
      [import_three38.RedFormat, 1],
      [import_three38.RGFormat, 2],
      [import_three38.RGBFormat, 3],
      [import_three38.RGBAFormat, 4]
    ]);
    let data;
    if (!channels.has(format)) {
      console.error("Invalid noise texture format");
    }
    if (type === import_three38.UnsignedByteType) {
  ...
  var NoiseTexture = class extends import_three38.DataTexture {
    constructor(width, height, format = import_three38.LuminanceFormat, type = import_three38.UnsignedByteType) {
  ...
  var GlitchEffect = class extends Effect {
    constructor({
      ...
      delay = new import_three39.Vector2(1.5, 3.5),
      duration = new import_three39.Vector2(0.6, 1),
      strength = new import_three39.Vector2(0.3, 1),
      columns = 0.05,
      ratio = 0.85,
      ...
      super("GlitchEffect", shader_default55, {
        blendFunction,
        uniforms: new Map([
          ["perturbationMap", new import_three39.Uniform(null)],
          ["columns", new import_three39.Uniform(columns)],
          ["active", new import_three39.Uniform(false)],
          ["random", new import_three39.Uniform(1)],
          ["seed", new import_three39.Uniform(new import_three39.Vector2())],
          ["distortion", new import_three39.Uniform(new import_three39.Vector2())]
        ])
      });
      this.setPerturbationMap(perturbationMap === null ? this.generatePerturbationMap(dtSize) : perturbationMap);
      this.delay = delay;
      this.duration = duration;
      this.breakPoint = new import_three39.Vector2(randomFloat(this.delay.x, this.delay.y), randomFloat(this.duration.x, this.duration.y));
      this.time = 0;
    ...
    setPerturbationMap(map) {
      ...
      map.minFilter = map.magFilter = import_three39.NearestFilter;
      map.wrapS = map.wrapT = import_three39.RepeatWrapping;
      map.generateMipmaps = false;
      this.uniforms.get("perturbationMap").value = map;
    }
    generatePerturbationMap(size = 64) {
      const map = new NoiseTexture(size, size, import_three39.RGBFormat);
      map.name = tag;
      return map;
    }
    update(renderer, inputBuffer, deltaTime) {
  ...
  var shader_default56 = "uniform sampler2D texture;void mainImage(const in vec4 inputColor,const in vec2 uv,out vec4 outputColor){outputColor=texture2D(texture,uv);}";

  // src/effects/GodRaysEffect.js
  var v = new import_three40.Vector3();
  var m = new import_three40.Matrix4();
  var GodRaysEffect = class extends Effect {
    constructor(camera, lightSource, {
      ...
      super("GodRaysEffect", shader_default56, {
        ...
        attributes: EffectAttribute.DEPTH,
        uniforms: new Map([
          ["texture", new import_three40.Uniform(null)]
        ])
      });
      this.camera = camera;
      ...
      this.lightScene = new import_three40.Scene();
      this.screenPosition = new import_three40.Vector2();
      this.renderTargetA = new import_three40.WebGLRenderTarget(1, 1, {
      ...
      this.renderTargetLight.depthTexture = new import_three40.DepthTexture();
      this.renderPassLight = new RenderPass(this.lightScene, camera);
      this.renderPassLight.getClearPass().overrideClearColor = new import_three40.Color(0);
      this.clearPass = new ClearPass(true, false, false);
      this.clearPass.overrideClearColor = new import_three40.Color(0);
      this.blurPass = new BlurPass({resolutionScale, width, height, kernelSize});
      this.blurPass.resolution.resizable = this;
    ...
    initialize(renderer, alpha, frameBufferType) {
      ...
      if (!alpha && frameBufferType === import_three40.UnsignedByteType) {
        this.renderTargetA.texture.format = import_three40.RGBFormat;
        this.renderTargetB.texture.format = import_three40.RGBFormat;
        this.renderTargetLight.texture.format = import_three40.RGBFormat;
      }
      if (frameBufferType !== void 0) {
        this.renderTargetA.texture.type = frameBufferType;
        this.renderTargetB.texture.type = frameBufferType;
  ...
  var GridEffect = class extends Effect {
    constructor({blendFunction = BlendFunction.OVERLAY, scale = 1, lineWidth = 0} = {}) {
      super("GridEffect", shader_default57, {
        blendFunction,
        uniforms: new Map([
          ["scale", new import_three41.Uniform(new import_three41.Vector2())],
          ["lineWidth", new import_three41.Uniform(lineWidth)]
        ])
      });
      this.resolution = new import_three41.Vector2();
  ...
  var HueSaturationEffect = class extends Effect {
    constructor({blendFunction = BlendFunction.NORMAL, hue = 0, saturation = 0} = {}) {
      super("HueSaturationEffect", shader_default58, {
        blendFunction,
        uniforms: new Map([
          ["hue", new import_three42.Uniform(new import_three42.Vector3())],
          ["saturation", new import_three42.Uniform(saturation)]
        ])
      });
      this.setHue(hue);
    }
  ...
  var LUTEffect = class extends Effect {
    constructor(lut, {blendFunction = BlendFunction.NORMAL} = {}) {
      super("LUTEffect", shader_default59, {
        blendFunction,
        uniforms: new Map([
          ["lut", new import_three43.Uniform(null)]
        ])
      });
      this.inputEncoding = import_three43.sRGBEncoding;
      this.setInputEncoding(import_three43.sRGBEncoding);
      this.setLUT(lut);
    }
    getInputEncoding() {
    ...
    setInputEncoding(value) {
      ...
      switch (value) {
        case import_three43.sRGBEncoding:
          defines.set("linearToInputTexel(texel)", "LinearTosRGB(texel)");
          break;
        case import_three43.LinearEncoding:
    ...
    setLUT(value) {
      ...
      if (this.getLUT() !== value) {
        ...
        if (value.type === import_three43.FloatType) {
  ...
  var OutlineEffect = class extends Effect {
    constructor(scene, camera, {
      ...
      super("OutlineEffect", shader_default61, {
        uniforms: new Map([
          ...
          ["patternScale", new import_three44.Uniform(1)],
      ...
      this.renderTargetMask = new import_three44.WebGLRenderTarget(1, 1, {
        ...
        stencilBuffer: false,
        format: import_three44.RGBFormat
      });
    ...
    setPatternTexture(texture) {
      if (texture !== null) {
        texture.wrapS = texture.wrapT = import_three44.RepeatWrapping;
    ...
    constructor(granularity = 30) {
      super("PixelationEffect", shader_default63, {
        uniforms: new Map([
          ...
          ["d", new import_three45.Uniform(new import_three45.Vector2())]
        ])
      });
  ...
  var v2 = new import_three48.Vector3();
  var ab = new import_three48.Vector3();
  var ShockWaveEffect = class extends Effect {
    constructor(camera, epicenter = new import_three48.Vector3(), {
      speed = 2,
      maxRadius = 1,
      waveSize = 0.2,
      amplitude = 0.05
  ...
  var SelectiveBloomEffect = class extends BloomEffect {
    constructor(scene, camera, options) {
      ...
      this.blackoutPass = new RenderPass(scene, camera, new import_three49.MeshBasicMaterial({color: 0}));
      this.blackoutPass.clear = false;
      this.backgroundPass = (() => {
        const backgroundScene = new import_three49.Scene();
        const pass = new RenderPass(backgroundScene, camera);
        backgroundScene.background = scene.background;
        pass.clear = false;
        return pass;
      })();
      this.renderTargetSelection = new import_three49.WebGLRenderTarget(1, 1, {
    ...
    initialize(renderer, alpha, frameBufferType) {
      ...
      if (!alpha && frameBufferType === import_three49.UnsignedByteType) {
        this.renderTargetSelection.texture.format = import_three49.RGBFormat;
      }
      if (frameBufferType !== void 0) {
  ...
  var SepiaEffect = class extends Effect {
    constructor({blendFunction = BlendFunction.NORMAL, intensity = 1} = {}) {
      super("SepiaEffect", shader_default68, {
        blendFunction,
        uniforms: new Map([
          ["intensity", new import_three50.Uniform(intensity)]
        ])
      });
    }
  };
  ...
  var SMAAEffect = class extends Effect {
    constructor(searchImage, areaImage, preset = SMAAPreset.HIGH, edgeDetectionMode = EdgeDetectionMode.COLOR) {
      super("SMAAEffect", shader_default69, {
        ...
        attributes: EffectAttribute.CONVOLUTION | EffectAttribute.DEPTH,
        uniforms: new Map([
          ["weightMap", new import_three51.Uniform(null)]
        ])
      });
      this.renderTargetEdges = new import_three51.WebGLRenderTarget(1, 1, {
      ...
      this.renderTargetWeights.texture.format = import_three51.RGBAFormat;
      this.uniforms.get("weightMap").value = this.renderTargetWeights.texture;
      this.clearPass = new ClearPass(true, false, false);
      this.clearPass.overrideClearColor = new import_three51.Color(0);
      this.clearPass.overrideClearAlpha = 1;
      this.edgeDetectionPass = new ShaderPass(new EdgeDetectionMaterial(new import_three51.Vector2(), edgeDetectionMode));
      this.weightsPass = new ShaderPass(new SMAAWeightsMaterial());
      const searchTexture = new import_three51.Texture(searchImage);
      searchTexture.name = "SMAA.Search";
      searchTexture.magFilter = import_three51.NearestFilter;
      searchTexture.minFilter = import_three51.NearestFilter;
      searchTexture.format = import_three51.RGBAFormat;
      searchTexture.generateMipmaps = false;
      searchTexture.needsUpdate = true;
      searchTexture.flipY = true;
      const areaTexture = new import_three51.Texture(areaImage);
      areaTexture.name = "SMAA.Area";
      areaTexture.minFilter = import_three51.LinearFilter;
      areaTexture.format = import_three51.RGBAFormat;
  ...
  var SSAOEffect = class extends Effect {
    constructor(camera, normalBuffer, {
      ...
      super("SSAOEffect", shader_default71, {
        ...
        attributes: EffectAttribute.DEPTH,
        uniforms: new Map([
          ["aoBuffer", new import_three52.Uniform(null)],
          ["normalDepthBuffer", new import_three52.Uniform(null)],
          ["luminanceInfluence", new import_three52.Uniform(luminanceInfluence)],
          ["color", new import_three52.Uniform(null)],
          ["scale", new import_three52.Uniform(0)]
        ])
      });
      this.renderTargetAO = new import_three52.WebGLRenderTarget(1, 1, {
      ...
      this.ssaoPass = new ShaderPass((() => {
        ...
        noiseTexture.wrapS = noiseTexture.wrapT = import_three52.RepeatWrapping;
    ...
    set color(value) {
      ...
      if (value !== null) {
        if (defines.has("COLORIZE")) {
          ...
          uniforms.get("color").value = new import_three52.Color(value);
          this.setChanged();
        }
  ...
  var TextureEffect = class extends Effect {
    constructor({blendFunction = BlendFunction.NORMAL, texture = null, aspectCorrection = false} = {}) {
      super("TextureEffect", shader_default72, {
        ...
        uniforms: new Map([
          ["texture", new import_three53.Uniform(null)],
          ["scale", new import_three53.Uniform(1)],
          ["uvTransform", new import_three53.Uniform(null)]
        ])
      });
    ...
    set texture(value) {
      ...
      if (currentTexture !== value) {
        ...
        if (value !== null) {
          switch (value.encoding) {
            case import_three53.sRGBEncoding:
              this.defines.set("texelToLinear(texel)", "sRGBToLinear(texel)");
              break;
            case import_three53.LinearEncoding:
    ...
    set uvTransform(value) {
      if (this.uvTransform !== value) {
        if (value) {
          ...
          this.uniforms.get("uvTransform").value = new import_three53.Matrix3();
          this.setVertexShader(shader_default73);
        } else {
  ...
  var ToneMappingEffect = class extends Effect {
    constructor({
      ...
      super("ToneMappingEffect", shader_default74, {
        blendFunction,
        uniforms: new Map([
          ["luminanceBuffer", new import_three54.Uniform(null)],
          ["toneMappingExposure", new import_three54.Uniform(1)],
          ["maxLuminance", new import_three54.Uniform(maxLuminance)],
          ["whitePoint", new import_three54.Uniform(whitePoint)],
          ["middleGrey", new import_three54.Uniform(middleGrey)],
          ["averageLuminance", new import_three54.Uniform(averageLuminance)]
        ])
      });
      this.renderTargetLuminance = new import_three54.WebGLRenderTarget(1, 1, {
        minFilter: import_three54.LinearMipmapLinearFilter !== void 0 ? import_three54.LinearMipmapLinearFilter : import_three54.LinearMipMapLinearFilter,
        magFilter: import_three54.LinearFilter,
        stencilBuffer: false,
        depthBuffer: false,
  ...
  var VignetteEffect = class extends Effect {
    constructor(options = {}) {
      ...
      super("VignetteEffect", shader_default75, {
        ...
        uniforms: new Map([
          ["offset", new import_three55.Uniform(settings.offset)],
          ["darkness", new import_three55.Uniform(settings.darkness)]
        ])
      });
  ...
  // src/images/textures/LookupTexture3D.js
  var c = new import_three56.Color();
  var LookupTexture3D = class extends import_three56.DataTexture3D {
    constructor(data, size) {
      super(data, size, size, size);
      this.type = import_three56.FloatType;
      this.format = import_three56.RGBFormat;
      this.encoding = import_three56.LinearEncoding;
      this.magFilter = import_three56.LinearFilter;
      this.wrapS = import_three56.ClampToEdgeWrapping;
      this.wrapT = import_three56.ClampToEdgeWrapping;
      this.wrapR = import_three56.ClampToEdgeWrapping;
    ...
    applyLUT(lut) {
      ...
      } else if (lut.type !== import_three56.FloatType || this.type !== import_three56.FloatType) {
    ...
    convertToUint8() {
      if (this.type === import_three56.FloatType) {
        ...
        this.type = import_three56.UnsignedByteType;
      }
      return this;
    }
    convertToFloat() {
      if (this.type === import_three56.UnsignedByteType) {
    ...
    convertLinearToSRGB() {
      ...
      if (this.type === import_three56.FloatType) {
        ...
        this.encoding = import_three56.sRGBEncoding;
      } else {
    ...
    toDataTexture() {
      ...
      const texture = new import_three56.DataTexture(this.image.data, width, height);
  ...
  var LUT3dlLoader = class extends import_three57.Loader {
    load(url, onLoad = () => {
    }, onProgress = () => {
    }, onError = () => {
    }) {
      const externalManager = this.manager;
      const internalManager = new import_three57.LoadingManager();
      const loader = new import_three57.FileLoader(internalManager);
    ...
    parse(input) {
      ...
      lut.encoding = import_three57.sRGBEncoding;
      return lut;
    }
  };
  ...
  var LUTCubeLoader = class extends import_three58.Loader {
    load(url, onLoad = () => {
    }, onProgress = () => {
    }, onError = () => {
    }) {
      const externalManager = this.manager;
      const internalManager = new import_three58.LoadingManager();
      const loader = new import_three58.FileLoader(internalManager);
      loader.setPath(this.path);
      loader.setResponseType("text");
      return new Promise((resolve, reject) => {
        internalManager.onError = (error) => {
    ...
    parse(input) {
      ...
      const data = new Float32Array(size ** 3 * 3);
      const domainMin = new import_three58.Vector3(0, 0, 0);
      const domainMax = new import_three58.Vector3(1, 1, 1);
      ...
      const lut = new LookupTexture3D(data, size, size, size);
      lut.encoding = import_three58.sRGBEncoding;
      if (title !== null) {
        lut.name = title;
      }
      return lut;
  ...
  function generate(disableCache = false) {
    const workerURL = URL.createObjectURL(new Blob([smaa_default], {type: "text/javascript"}));
    const worker = new Worker(workerURL);
    return new Promise((resolve, reject) => {
      worker.addEventListener("error", (event) => reject(event.error));
      worker.addEventListener("message", (event) => {
  ...
  var SMAAImageLoader = class extends import_three59.Loader {
    constructor(manager) {
      super(manager);
    ...
    load(onLoad = () => {
      ...
      const externalManager = this.manager;
      const internalManager = new import_three59.LoadingManager();
      externalManager.itemStart("smaa-search");
      externalManager.itemStart("smaa-area");
      internalManager.itemStart("smaa-search");
      internalManager.itemStart("smaa-area");
      return new Promise((resolve, reject) => {
        const cachedURLs = !this.disableCache && window.localStorage !== void 0 ? [
