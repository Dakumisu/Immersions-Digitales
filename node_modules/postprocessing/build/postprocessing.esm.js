...
import {NoBlending as NoBlending9, ShaderMaterial as ShaderMaterial9, Uniform as Uniform9} from "three";
...
var EffectComposer = class {
  ...
  createBuffer(depthBuffer, stencilBuffer, type, multisampling) {
    ...
    const options = {
      format: !alpha && type === UnsignedByteType3 ? RGBFormat4 : RGBAFormat2,
    ...
    const renderTarget = multisampling > 0 ? new WebGLMultisampleRenderTarget(size.width, size.height, options) : new WebGLRenderTarget7(size.width, size.height, options);
    if (multisampling > 0) {
...
import {LinearFilter as LinearFilter4, RGBFormat as RGBFormat5, Uniform as Uniform19, UnsignedByteType as UnsignedByteType4, WebGLRenderTarget as WebGLRenderTarget8} from "three";
...
import {LinearFilter as LinearFilter5, RGBFormat as RGBFormat6, Uniform as Uniform24, UnsignedByteType as UnsignedByteType5, WebGLRenderTarget as WebGLRenderTarget9} from "three";
...
var NoiseTexture = class extends DataTexture {
  constructor(width, height, format = LuminanceFormat, type = UnsignedByteType6) {
...
var GodRaysEffect = class extends Effect {
  constructor(camera, lightSource, {
    ...
    this.renderTargetA = new WebGLRenderTarget10(1, 1, {
...
import {FloatType as FloatType2, LinearEncoding, sRGBEncoding, Uniform as Uniform31} from "three";
  ...
  constructor(scene, camera, {
    ...
    super("OutlineEffect", shader_default61, {
      uniforms: new Map([
        ...
        ["visibleEdgeColor", new Uniform32(new Color5(visibleEdgeColor))],
        ["hiddenEdgeColor", new Uniform32(new Color5(hiddenEdgeColor))],
    ...
    this.scene = scene;
    this.camera = camera;
    this.renderTargetMask = new WebGLRenderTarget11(1, 1, {
...
import {Uniform as Uniform36, Vector2 as Vector220, Vector3 as Vector33} from "three";
...
var ShockWaveEffect = class extends Effect {
  constructor(camera, epicenter = new Vector33(), {
    speed = 2,
    maxRadius = 1,
    waveSize = 0.2,
    amplitude = 0.05
...
var SelectiveBloomEffect = class extends BloomEffect {
  constructor(scene, camera, options) {
    ...
    this.blackoutPass = new RenderPass(scene, camera, new MeshBasicMaterial({color: 0}));
    this.blackoutPass.clear = false;
    this.backgroundPass = (() => {
      const backgroundScene = new Scene4();
      const pass = new RenderPass(backgroundScene, camera);
      backgroundScene.background = scene.background;
      pass.clear = false;
      return pass;
    })();
    this.renderTargetSelection = new WebGLRenderTarget12(1, 1, {
  ...
  initialize(renderer, alpha, frameBufferType) {
    ...
    if (!alpha && frameBufferType === UnsignedByteType9) {
      this.renderTargetSelection.texture.format = RGBFormat11;
    }
    if (frameBufferType !== void 0) {
...
var SMAAEffect = class extends Effect {
  constructor(searchImage, areaImage, preset = SMAAPreset.HIGH, edgeDetectionMode = EdgeDetectionMode.COLOR) {
    ...
    this.renderTargetEdges = new WebGLRenderTarget13(1, 1, {
      minFilter: LinearFilter9,
      stencilBuffer: false,
      depthBuffer: false,
      format: RGBFormat12
    });
    ...
    this.renderTargetWeights.texture.format = RGBAFormat4;
    ...
    searchTexture.magFilter = NearestFilter6;
    searchTexture.minFilter = NearestFilter6;
    searchTexture.format = RGBAFormat4;
    searchTexture.generateMipmaps = false;
    searchTexture.needsUpdate = true;
    searchTexture.flipY = true;
    const areaTexture = new Texture(areaImage);
    areaTexture.name = "SMAA.Area";
    areaTexture.minFilter = LinearFilter9;
    areaTexture.format = RGBAFormat4;
...
var SSAOEffect = class extends Effect {
  constructor(camera, normalBuffer, {
    ...
    this.renderTargetAO = new WebGLRenderTarget14(1, 1, {
...
import {LinearEncoding as LinearEncoding2, Matrix3, sRGBEncoding as sRGBEncoding2, Uniform as Uniform40} from "three";
  ...
  constructor({
    ...
    super("ToneMappingEffect", shader_default74, {
      ...
      uniforms: new Map([
        ...
        ["toneMappingExposure", new Uniform41(1)],
    ...
    this.renderTargetLuminance = new WebGLRenderTarget15(1, 1, {
...
var LookupTexture3D = class extends DataTexture3D {
  constructor(data, size) {
    ...
    this.format = RGBFormat15;
    this.encoding = LinearEncoding3;
    this.magFilter = LinearFilter12;
...
import {FileLoader, Loader, LoadingManager, sRGBEncoding as sRGBEncoding4} from "three";
...
import {FileLoader as FileLoader2, Loader as Loader2, LoadingManager as LoadingManager2, sRGBEncoding as sRGBEncoding5, Vector3 as Vector34} from "three";
var LUTCubeLoader = class extends Loader2 {
  ...
  parse(input) {
    ...
    const data = new Float32Array(size ** 3 * 3);
    const domainMin = new Vector34(0, 0, 0);
    const domainMax = new Vector34(1, 1, 1);
...
import {Loader as Loader3, LoadingManager as LoadingManager3} from "three";
