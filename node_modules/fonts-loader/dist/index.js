...
},{"core-js/shim":"../node_modules/core-js/shim.js","regenerator-runtime/runtime":"../node_modules/babel-polyfill/node_modules/regenerator-runtime/runtime.js","core-js/fn/regexp/escape":"../node_modules/core-js/fn/regexp/escape.js"}],"../node_modules/fontfaceobserver-es/dist/fontfaceobserver.umd.js":[function(require,module,exports) {
var define;
...
/*#__PURE__*/
function () {
  function FontsLoader(fonts) {
    var _this = this;

    var _ref = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
        _ref$timer = _ref.timer,
        timer = _ref$timer === void 0 ? 20000 : _ref$timer,
    ...
    this.silent = silent;
    this.error = error;
    if (document.fonts && !this.silent) document.fonts.ready.then(function () {
      return console.warn("Font loading is done. Event is fired in both successul and failed cases.");
    }); // Fonts Array|Object

    if (Array.isArray(fonts)) this.fonts = fonts;else this.fonts = [fonts]; // Check if fonts do not have source

    this.fonts = this.fonts.filter(function (font) {
      if (!font.source && _this.error) console.error("Font ".concat(font.name, ". No source provided."));else return font;
    });
    if (document.fonts) this.promise = this.loadNative();else this.promise = this.loadWithObserver();
  }

  _createClass(FontsLoader, [{
    key: "then",
    value: function then(fn) {
      if (this.promise) this.promise.then(fn);
    }
  }, {
    key: "catch",
    value: function _catch(fn) {
      if (this.promise) this.promise.catch(fn);
    }
  }, {
    key: "loadNative",
    value: function loadNative() {
      // Create FontFaces
      this.promises = this.fonts.map(function (_ref2) {
        var name = _ref2.name,
            source = _ref2.source,
            descriptor = _ref2.descriptor;
        return new FontFace(name, "url(".concat(source, ")"), descriptor);
      }).map(function (fc) {
        return document.fonts.add(fc) && fc;
      }).map(
      /*#__PURE__*/
      function () {
        var _ref3 = _asyncToGenerator(
        /*#__PURE__*/
        regeneratorRuntime.mark(function _callee(fc) {
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                ...
                case 4:
                  ...
                  return _context.abrupt("return", _context.t0.resolve.call(_context.t0, _context.t1));
    ...
    key: "wrapIntoPromise",
    value: function wrapIntoPromise(promises) {
      var _this2 = this;

      return new Promise(function (resolve, reject) {
        Promise.all(promises).then(function (results) {
          var fonts, errors;
          if (document.fonts) fonts = results.filter(function (fc) {
            return fc instanceof FontFace;
          }).map(function (fc) {
            return fc.loaded;
          });else fonts = results.filter(function (fc) {
            return !fc instanceof Error;
          });
          errors = results.filter(function (fc) {
            return fc instanceof Error;
          });
          if (_this2.error) _this2.handleErrors(errors);
          Promise.all(fonts).then(function (fonts) {
            return resolve(!_this2.silent && _this2.success(fonts));
          }).catch(function (err) {
            return reject(err);
          });
        });
    ...
    key: "loadWithObserver",
    value: function loadWithObserver() {
      var _this3 = this;

      var style = '';
      this.fonts.forEach(function (font) {
        return style += _this3.createFontFaceRule(font);
      });
      var styleTag = document.createElement('style');
      styleTag.type = 'text/css';
      styleTag.innerText = style;
      document.head.appendChild(styleTag);
      this.promises = this.fonts.map(
      /*#__PURE__*/
      function () {
        var _ref5 = _asyncToGenerator(
        /*#__PURE__*/
        regeneratorRuntime.mark(function _callee2(_ref4) {
          var name, descriptor, fc;
          return regeneratorRuntime.wrap(function _callee2$(_context2) {
            while (1) {
              switch (_context2.prev = _context2.next) {
                case 0:
                  name = _ref4.name, descriptor = _ref4.descriptor;
                  _context2.prev = 1;
                  fc = new _fontfaceobserverEs.default(name, descriptor);
                  _context2.t0 = Promise;
                  _context2.next = 6;
                  return fc.load(null, _this3.timer);
    ...
    value: function createFontFaceRule(font) {
      return "\n        @font-face {\n            font-family: '".concat(font.name, "';\n            font-style: ").concat(font.descriptor ? font.descriptor.style : 'normal', ";\n            font-weight: ").concat(font.descriptor ? font.descriptor.weight : 'normal', ";\n            src: url('").concat(font.source, "') format(\"truetype\");\n        }");
    }
  }, {
    key: "handleErrors",
    ...
    key: "success",
    value: function success(fonts) {
      return "FONTS: ".concat(fonts.map(function (fc) {
        return fc.family;
      }).join(', '), " loaded.");
    }
  }]);
...
},{"babel-polyfill":"../node_modules/babel-polyfill/lib/index.js","fontfaceobserver-es":"../node_modules/fontfaceobserver-es/dist/fontfaceobserver.umd.js"}],"index.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
Object.defineProperty(exports, "FontsLoader", {
  enumerable: true,
  get: function () {
    return _loader.FontsLoader;
  }
});

var _loader = require("./loader");
},{"./loader":"../src/loader.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
