(function (global, factory) {
  ...
  var singletonVec3b = new three.Vector3();
  ...
  var DirectionalLight3DFacade = createLightFacade(three.DirectionalLight, three.DirectionalLightHelper);
  var SpotLight3DFacade = createLightFacade(three.SpotLight, three.SpotLightHelper);
  var PointLight3DFacade = createLightFacade(three.PointLight, three.PointLightHelper);
  var HemisphereLight3DFacade = createLightFacade(three.HemisphereLight, three.HemisphereLightHelper, {
    groundColor: {
      set: function set(c) {
  ...
  var RectAreaLight3DFacade = createLightFacade(three.RectAreaLight);
  ...
  function getInstancingDerivedMaterial(baseMaterial) {
    var instanceUniforms = baseMaterial.instanceUniforms;
  ...
  var InstancingManager = /*@__PURE__*/(function (Group3DFacade) {
    ...
    InstancingManager.prototype._getInstanceUniformSizes = function _getInstanceUniformSizes (material) {
      ...
      if (!result) {
        ...
        if (material.instanceUniforms) {
          material.instanceUniforms.forEach(function (name) {
    ...
    InstancingManager.prototype._getBatchObject = function _getBatchObject (instancedObject) {
      ...
      var uniformSizes = this._getInstanceUniformSizes(material);
      ...
      var batchMaterial = getInstancingDerivedMaterial(material);
  ...
  BatchGeometryPool.prototype.borrow = function borrow (key, baseGeometry, instanceUniformSizes) {
    ...
    if (!batchGeometry) {
      ...
      for (var name in instanceUniformSizes) {
        ...
        var attr$1 = new three.InstancedBufferAttribute(new Float32Array(INSTANCE_BATCH_SIZE * itemSize), itemSize);
        if (attr$1.setUsage) {
  ...
  var MeshFacade = /*@__PURE__*/(function (Object3DFacade) {
    function MeshFacade (parent) {
      Object3DFacade.call(this, parent, new three.Mesh(dummyGeometry, dummyMaterial));
   ...
   */
  var getBoxGeometry = troikaCore.utils.memoize(function () {
    return new three.BoxBufferGeometry(1, 1, 1, 1, 1)
  });
   ...
   */
  var BoxFacade = /*@__PURE__*/(function (MeshFacade) {
    function BoxFacade () {
      MeshFacade.apply(this, arguments);
    }

    if ( MeshFacade ) BoxFacade.__proto__ = MeshFacade;
    BoxFacade.prototype = Object.create( MeshFacade && MeshFacade.prototype );
    BoxFacade.prototype.constructor = BoxFacade;

    var prototypeAccessors = { geometry: { configurable: true },width: { configurable: true },height: { configurable: true },depth: { configurable: true } };
    ...
    prototypeAccessors.height.set = function (height) {
      this.scaleY = height;
    };
    ...
    prototypeAccessors.depth.set = function (width) {
      this.scaleZ = width;
    };
    ...
    Object.defineProperties( BoxFacade.prototype, prototypeAccessors );
  ...
  var geometries = Object.create(null, [
    ...
    descr[name] = {
      get: troikaCore.utils.memoize(function () { return new three.CircleBufferGeometry(1, segments).rotateX(-Math.PI / 2); }
      )
    };
    return descr
  }, {}));
   ...
   * To control the material, see {@link MeshFacade}.
   */
  var CubeFacade = /*@__PURE__*/(function (MeshFacade) {
    function CubeFacade () {
      MeshFacade.apply(this, arguments);
    }

    if ( MeshFacade ) CubeFacade.__proto__ = MeshFacade;
    CubeFacade.prototype = Object.create( MeshFacade && MeshFacade.prototype );
    CubeFacade.prototype.constructor = CubeFacade;

    var prototypeAccessors = { geometry: { configurable: true },size: { configurable: true } };
    ...
    Object.defineProperties( CubeFacade.prototype, prototypeAccessors );

    return CubeFacade;
  }(MeshFacade));

  var getGeometry = troikaCore.utils.memoize(function () {
    return new three.PlaneBufferGeometry(1, 1, 1, 1).rotateX(-Math.PI / 2)
  });
   ...
   * To control the material, see {@link MeshFacade}.
   */
  var PlaneFacade = /*@__PURE__*/(function (MeshFacade) {
    function PlaneFacade (parent) {
      MeshFacade.call(this, parent);
      this['material.side'] = this['material.shadowSide'] = three.DoubleSide;
    }

    if ( MeshFacade ) PlaneFacade.__proto__ = MeshFacade;
    PlaneFacade.prototype = Object.create( MeshFacade && MeshFacade.prototype );
    PlaneFacade.prototype.constructor = PlaneFacade;

    var prototypeAccessors = { geometry: { configurable: true },width: { configurable: true },depth: { configurable: true } };
    ...
    Object.defineProperties( PlaneFacade.prototype, prototypeAccessors );
  ...
  var geometries$1 = Object.create(null, [
    ...
    descr[name] = {
      get: troikaCore.utils.memoize(function () { return new three.SphereBufferGeometry(1, wSegs, hSegs); })
    };
    return descr
  }, {}));
   ...
   * To control the material, see {@link MeshFacade}.
   */
  var SphereFacade = /*@__PURE__*/(function (MeshFacade) {
    function SphereFacade () {
      MeshFacade.apply(this, arguments);
    }

    if ( MeshFacade ) SphereFacade.__proto__ = MeshFacade;
    SphereFacade.prototype = Object.create( MeshFacade && MeshFacade.prototype );
    SphereFacade.prototype.constructor = SphereFacade;
    ...
    Object.defineProperties( SphereFacade.prototype, prototypeAccessors );
